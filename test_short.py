...
if __name__ == "__main__":
    ...
    test_fpath_label = "/home/disk1/wangshaoying/data/ucf101/train_test_list/test1_101.txt"
    train_fpath_label = "/home/disk1/wangshaoying/data/ucf101/train_test_list/train1_101.txt"
    db_fpath_label = "/home/disk1/wangshaoying/data/ucf101/train_test_list/db1_101.txt"

    test_loader = load_data(root_folder, test_fpath_label, batch_size * 10, False, 8, False)
    db_loader = load_data(root_folder, db_fpath_label, batch_size * 10, False, 8, False)
    train_loader = load_data(root_folder, train_fpath_label, batch_size * 10, False, 8, False)
    ...
    for epoch in range(int(num_epochs / 10)):
        backbone_path_dir = '/home/disk1/wangshaoying/video_src/video_gl/log/ucf101_101/backbone/' + f'{(epoch+1)*10}epoch.pth'
        hash_path_dir = '/home/disk1/wangshaoying/video_src/video_gl/log/ucf101_101/hash_layer/' + f'{(epoch+1)*10}epoch.pth'
